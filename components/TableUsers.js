  ...
  return (
    <Box sx={{ width: '100%' }}>
      <Box sx={{ width: '100%', mb: 2 }} >
        ...
        <EnhancedTableToolbar handlePageSizeChange={handlePageSizeChange} numSelected={selected.length}  theme ={theme} addIcon={addIcon} screenIcon={screenIcon} deleteUser={true}/>
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="center"><Box display="flex" alignItems="center" justifyContent="center">
                     {row.actions.view} {row.actions.ban}
                      </Box></TableCell>
